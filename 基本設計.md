...
| `namePrefix`      | `${currentFileNameWithoutExt}-`                                                                    | ファイル名の接頭辞     |
...
- 設定: `namePrefix: "${currentFileNameWithoutExt}-"`, `defaultName: "image-YYMMDD-HHmmss"`
...
ファイル名接頭辞: [${currentFileNameWithoutExt}-]
